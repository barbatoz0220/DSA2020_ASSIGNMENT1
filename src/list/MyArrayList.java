...
public class MyArrayList<E> implements java.util.List<E>{
    ...
    public boolean add(E e) {
        if(e == null) throw new NullPointerException("Cannot add null pointer");
    ...
    */
    ...
    public void add(int index, E element) {
        ...
        if(element == null) throw new NullPointerException("Cannot add null pointer");
        checkCapacity(this.size + 1); // Check if adding this will exceed permitted capacity
    ...
    public E remove(int index) {
        checkValidIndex(index, 0, size -1);
        E deletedElement = this.elements[index]; // Assign element at index to deletedElement
